...
import io.ib67.kiwi.range.IntRange;
...
public final class TickReceipt<T extends Tickable<T>> {
    ...
    /**
     * Also see {@link io.ib67.dash.scheduler.strategies.PeriodicTicks}
     *
     * @param consumer
     * @return
     */
     ...
     * A utility class for it: {@link io.ib67.dash.scheduler.strategies.PeriodicTicks}
     *
     * @param func
     * @return
     */
    ...
    /**
     * Set the name of receipt, for debugging
     *
    ...
    protected boolean tick(Object t) throws Throwable {
        if (tickLimit != 0) tickCounter++;
        if (tickCounter >= tickLimit) drop();
        if (always.size() != 0) {
    ...
    /**
     * The tickable will be unregistered after i ticks.
     *
     * @param i i, positive
     * @return self
     */
    public TickReceipt<T> onlyFor(int i) {
        IntRange.rangePositive().inRange(i);
        tickLimit = i;
        return this;
    }
}
